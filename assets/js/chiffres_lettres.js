...
let corps = $("#corps");
let btn_number =
    '<button class="btn btn-primary col-2" id=\'btn_number\' type="button">Chiffre</button>';
let btn_letter =
    '<button class="btn btn-success col-2" id=\'btn_letter\' type="button">Lettre</button>';
let lettre = $("#letter");
let nombre = $("#number");
...
let test = function () {
    ...
    $(corps).append(
        `<div id="btn_choix" class="mt-3">${btn_letter}${btn_number}</div>`
    );
